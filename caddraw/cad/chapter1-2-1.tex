...
\item 【视图】$\mapsto$【左视】图标\includegraphics[scale=0.6]{toptool.png}。
\end{itemize}
...
\item 【绘图】$\mapsto$【直线】图标\includegraphics[scale=0.6]{linetool.png}。
\end{itemize}
...
\item 【修改】$\mapsto$【偏移】图标\includegraphics[scale=0.6]{offsettool.png}。
\end{itemize}
...
\item 【修改】$\mapsto$【修剪】图标\includegraphics[scale=0.6]{trimtool.png}。
\end{itemize}
