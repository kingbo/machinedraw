...
\begin{figure}[htbp]
\subfloat[特征平面]{\label{fig:tezhengpinmian.png}\includegraphics[scale=0.7]{tezhengpinmian.png}}\hspace{60pt}
...
\centering
\begin{floatrow}
\ffigbox[2.2\FBwidth]{\caption{“对象捕捉”菜单一}\label{fig:duixiangbuzuomen2}}{\includegraphics[scale=0.5]{duixiangbuzuomen2.png}}
\ffigbox[2.2\FBwidth]{\caption{“对象捕捉”菜单二}\label{fig:duixiangbuzuomen1}}{\includegraphics[scale=0.6]{duixiangbuzuomen1.png}}
\end{floatrow}
\end{figure}
