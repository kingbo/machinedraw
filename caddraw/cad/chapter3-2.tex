...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:fagaicenterline}\includegraphics[scale=0.35]{fagaicenterline.png}}\hspace{30pt}
\subfloat[]{\label{fig:fagai2}\includegraphics[scale=0.35]{fagai2.png}}\hspace{30pt}
\subfloat[]{\label{fig:fagai3}\includegraphics[scale=0.35]{fagai3.png}}
\caption{阀盖体绘制过程}
\end{figure}
\item 绘制盖体
...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:fagai4}\includegraphics[scale=0.35]{fagai4.png}}\hspace{30pt}
\subfloat[]{\label{fig:fagai5}\includegraphics[scale=0.35]{fagai5.png}}\hspace{30pt}
\subfloat[]{\label{fig:fagai6}\includegraphics[scale=0.35]{fagai6.png}}
\caption{阀盖定位块绘制过程}
\end{figure}
...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:fagai7}\includegraphics[scale=0.5]{fagai7.png}}\hspace{30pt}
\subfloat[]{\label{fig:fagai8}\includegraphics[scale=0.5]{fagai8.png}}\hspace{30pt}
\caption{阀盖主视图阵列过程}
\end{figure}
面域阀盖定位块。
\begin{lstlisting}
