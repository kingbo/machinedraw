...
\centering
\begin{floatrow}[3]
\ffigbox{\caption{绘$\phi 24$圆柱体}\label{fig:duangaisolid1}}{\includegraphics[scale=0.5]{duangaisolid1.png}}
\ffigbox{\caption{绘$\phi 24$圆柱体}\label{fig:duangaisolid2}}{\includegraphics[scale=0.5]{duangaisolid2.png}}
\ffigbox{\caption{绘$\phi 42$圆柱体}\label{fig:duangaisolid3}}{\includegraphics[scale=0.4]{duangaisolid3.png}}
\end{floatrow}
\end{figure}
\begin{lstlisting}
|命令: cylinder|
...
\centering
\begin{floatrow}[3]
\ffigbox{\caption{绘$\phi 62$圆柱体}\label{fig:duangaisolid4}}{\includegraphics[scale=0.4]{duangaisolid4.png}}
\ffigbox{\caption{绘$\phi 9$圆柱体}\label{fig:duangaisolid5}}{\includegraphics[scale=0.4]{duangaisolid5.png}}
\ffigbox{\caption{绘$\phi 104$圆柱体}\label{fig:duangaisolid6}}{\includegraphics[scale=0.3]{duangaisolid6.png}}
\end{floatrow}
\end{figure}
\begin{lstlisting}
|命令: cylinder|
...
\item 【实体编辑】$\triangleright$【圆角边】图标\includegraphics[scale=0.6]{filletedge.png}。
\end{itemize} 
