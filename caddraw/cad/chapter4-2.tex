...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:duangaisolid1}\includegraphics[scale=0.5]{duangaisolid1.png}}\hspace{30pt}
\subfloat[]{\label{fig:duangaisolid2}\includegraphics[scale=0.5]{duangaisolid2.png}}
\hspace{30pt}
\subfloat[]{\label{fig:duangaisolid3}\includegraphics[scale=0.4]{duangaisolid3.png}}
\caption{端盖实体建模过程1}
\end{figure}
\begin{lstlisting}
|命令: cylinder|
...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:duangaisolid4}\includegraphics[scale=0.4]{duangaisolid4.png}}\hspace{30pt}
\subfloat[]{\label{fig:duangaisolid5}\includegraphics[scale=0.4]{duangaisolid5.png}}
\hspace{30pt}
\subfloat[]{\label{fig:duangaisolid6}\includegraphics[scale=0.3]{duangaisolid6.png}}
\caption{端盖实体建模过程1}
\end{figure}
\begin{lstlisting}
|命令: cylinder|
...
\item 点击【实体编辑】工具栏中的【圆角边】图标\includegraphics[scale=0.6]{filletedge.png}。
\end{itemize} 
