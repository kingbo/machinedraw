...
\begin{itemize}
\item 键盘输入COPY\index{copy}或CO。
\item 【修改】$\rightarrow$【复制】。
\item 【修改】$\triangleright$【复制】图标\includegraphics[scale=0.6]{copy.png}。
\end{itemize}
\begin{lstlisting}
|命令: COPY|
|选择对象: 指定对角点: 找到 3 个|
...
\begin{itemize}
\item 键盘输入SOLIDEDIT\index{solidedit}，选择【面F】选项中的【拉伸E】选项。
\item 【修改】$\rightarrow$【实体编辑】$\rightarrow$【拉伸面】。
\item 【实体编辑】$\triangleright$【拉伸面】图标\includegraphics[scale=0.6]{solideditface.png}
\end{itemize}
用鼠标点击拉伸面图标。
\begin{lstlisting}
|命令: solidedit|
...
移动命令的启动方法有：
\begin{itemize}
\item 键盘输入MOVE\index{move}或M。
\item 【修改】$\rightarrow$【移动】。
\item 【修改】$\triangleright$【移动】图标\includegraphics[scale=0.6]{move.png}.
\end{itemize}
