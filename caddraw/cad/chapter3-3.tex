...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:fagai9}\includegraphics[scale=0.55]{fagai9.png}}\hspace{30pt}
\subfloat[]{\label{fig:fagai10}\includegraphics[scale=0.55]{fagai10.png}}\\
\subfloat[]{\label{fig:fagai11}\includegraphics[scale=0.55]{fagai11.png}}\hspace{30pt}
\subfloat[]{\label{fig:fagai12}\includegraphics[scale=0.55]{fagai12.png}}\\
\caption{阀盖拉伸过程}
\end{figure}
...
\end{procedure}
\begin{figure}[htbp]
\includegraphics[scale=1]{fagailititu.png}
