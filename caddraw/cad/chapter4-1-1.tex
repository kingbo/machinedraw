...
图\ref{fig:jiejiao15}为倾斜于轴线且倾斜角度等于锥角的截面切割圆锥体的结果，其截面为直线与抛物线构成的封闭线框。从图\ref{fig:jiejiao16}所示的三视图可知，该封闭框构成的平面垂直于$V$面，其主视图投影积聚为一条直线，其俯视图和左视图为类似形的由线与抛物线构成的复合面。
\begin{figure}[htbp]
\centering
