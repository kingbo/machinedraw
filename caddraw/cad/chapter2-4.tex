...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:dianpiancenterline}\includegraphics[scale=0.5]{dianpiancenterline.png}}\hspace{30pt}
\subfloat[]{\label{fig:dianpian1}\includegraphics[scale=0.5]{dianpian1.png}}
\caption{垫片实体建模过程一}
\end{figure}
\item 切换视图为西南等轴测图。
...
\item 点击【建模】工具栏中的【圆柱体】图标\includegraphics[scale=0.6]{cylinder.png}。
\end{itemize}
...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:dianpian2}\includegraphics[scale=0.6]{dianpian2.png}}\hspace{30pt}
\subfloat[]{\label{fig:dianpian3}\includegraphics[scale=0.6]{dianpian3.png}}
\caption{垫片实体建模过程二}
\end{figure}
\item 关闭“中心线”图层。
...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:dianpian4}\includegraphics[scale=0.6]{dianpian4.png}}\hspace{30pt}
\subfloat[]{\label{fig:dianpian5}\includegraphics[scale=0.6]{dianpian5.png}}
\caption{垫片实体建模过程二}
\end{figure}
