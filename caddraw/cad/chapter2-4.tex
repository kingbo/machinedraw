...
\centering
\begin{floatrow}
\ffigbox{\caption{绘中心线}\label{fig:dianpiancenterline}}{\includegraphics[scale=0.35]{dianpiancenterline.png}}
\ffigbox{\caption{绘$\phi 108$圆柱体}\label{fig:dianpian1}}{\includegraphics[scale=0.35]{dianpian1.png}}
\end{floatrow}
\end{figure}
\item 切换视图为西南等轴测图。
...
\centering
\begin{floatrow}
\ffigbox{\caption{绘$\phi 53$圆柱体}\label{fig:dianpian2}}{\includegraphics[scale=0.5]{dianpian2.png}}\hspace{30pt}
\ffigbox{\caption{绘$\phi 8$圆柱体}\label{fig:dianpian3}}{\includegraphics[scale=0.5]{dianpian3.png}}
\end{floatrow}
\end{figure}
\item 关闭“中心线”图层。
...
\centering
\begin{floatrow}
\ffigbox{\caption{阵列$\phi 8$圆柱体}\label{fig:dianpian4}}{\includegraphics[scale=0.5]{dianpian4.png}}\hspace{30pt}
\ffigbox{\caption{垫片三维模型}\label{fig:dianpian5}}{\includegraphics[scale=0.5]{dianpian5.png}}
\end{floatrow}
\end{figure}
