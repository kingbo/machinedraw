...
\begin{figure}[htbp]
\centering
\subfloat[]{\label{fig:revnodeselecta}\includegraphics[scale=1.2]{revnodeselect1.png}}\hspace{30pt}
\subfloat[]{\label{fig:revnodeselectb}\includegraphics[scale=1.2]{revnodeselect2.png}}
\caption{旋转中心定义}
\end{figure}
