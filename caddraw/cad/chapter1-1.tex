...
爸爸：要理解视图，首先让我们来了解一下投影。投影是物体在阳光或灯光下所产生的影子。工程实际中为解决影子只能够表现物体轮廓的缺点，将物体内外空间几何元素加以抽象并用不同的线型进行表示，以实现物体的内外细节的表达，从而形成的比较完备的、实用的投影方法。投影法中分类中心投影法和平行投影法两类。所有的投影线者互不平行且汇聚于点的投影法称为中心投影法。此类投影法主要用于绘制效果比较逼真的建筑或产品立体图。实际
