...
接下来，按照规定将中心线图层的线型设置为ACAD\_ ISO04W100图线。具体设置方法为：单击中心线图层中的线型名，弹出如图所示的【选择线型】对话框。此时还没我所需要的线型，需要单击对话框中的【加载】按钮，弹出如图所示的【加载或重载线型】对话框，选择ACAD\_ ISO04W100图线，并确定，以完成线型加载。最后在【选择线型】对话框中选中新加载的ACAD\_ ISO04W100图线，再一次单击确定，完成线型的设置。
