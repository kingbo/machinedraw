...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.6]{shu3.pdf}
...
\indent
\clearpage
\section{平面几何作图（二）}\label{sec:falan}
...
\caption{定形尺寸}\label{fig:biaozu6}
\end{figure}
\indent
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.35]{biaozu5.pdf}
\caption{定位尺寸}\label{fig:biaozu5}
\end{figure}
\indent
