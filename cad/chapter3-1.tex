...
\centering
\begin{floatrow}
\ffigbox{\caption{长方体主视图绘制}\label{fig:cubezhushitu}}{\includegraphics{cubezhushitu.png}}
\ffigbox{\caption{三视图辅助线绘制}\label{fig:cubeaidline}}{
...
\centering
\begin{floatrow}
\ffigbox{\caption{长方体俯视图绘制}\label{fig:cubefushitu}}{\includegraphics{cubefushitu.png}}
...
\centering
\begin{floatrow}
\ffigbox{\caption{V沟槽主视图绘制}\label{fig:Vxingzhushitu}}{\includegraphics[scale=0.9]{Vxingzhushitu.png}}
\ffigbox{\caption{V型沟槽俯视图绘制}\label{fig:Vxingfushitu}}{
\includegraphics[scale=0.8]{Vxingfushitu.png}}
\end{floatrow}
\end{figure}
...
第三步：由于V型沟槽为通槽，在绘制长方体三视图时其宽度方向已经满足对应关系，故只需要以主视图为基础，就可以绘出其左视图。从立体图中可以看出，从左侧向W投影平面投影时，V型沟槽被遮挡，需要用虚线表示。因此我们选择虚线图层，利用对象捕捉，即可完成其左视图。完成该步骤后，V型块的三视图如图\ref{fig:Vxingthreeview}所示。
\begin{figure}[htpb]
\centering
\includegraphics[scale=0.7]{Vxingthreeview.png}
