...
morekeywords={line, pagesetup,  circle, xline, view, subtract, cylinder, vscurrent, union, chamferedge, save, saveas, mspace, pspace, solprof, layer, rectang, region, revolve, line, point, offset, trim, erase, copy, move, rotate, scale, stretch, extend, break, join, chamfer, fillet, filletedge, blend, explode, arc, polygon, pline, ellipse, insert, block, wblock, hatch, text, mtext, pan, zoom, dimlinear, arraypolay, arrayrect, mirror, style, dimstyle, dimcontinue, dimcont, dimlin, ucs, mirror3d, }, 
sensitive=false, 
}
