...
\hline
\endlastfoot
\centering{授课单元}&\multicolumn{3}{m{60mm}|}{\centering 电动机单向连续运行控制}&\centering{授课日期}&2014年03月12日 \\
\hline
...
\item 能够运用PLC进行单台电动机的单向连续运转控制
\item 能够运用STEP7软件编写简单的PLC控制程序
...
\item 编制电动机单向连续运转控制I/o分配表
\item 设计电动机单向连续运转PLC控制程序
\item PLC控制接线
\item PLC控制程序输入
\item PLC控制检验
\end{enumerate}}\\
\hline
\centering 教学重点 & \multicolumn{5}{m{108mm}|}{电动机的起动保持}\\
\hline
...
\mode<presentation>{ \section{电动机单向连续正转控制} }
