...
\hline
\endlastfoot
\centering{授课单元}&\multicolumn{3}{m{60mm}|}{\centering 具有报警功能的电动机单向连续运行控制}&\centering{授课日期}&2014年03月12日 \\
\hline
...
\item 能够运用置位和复位指令实现具有报警功能的电动机单向连续运转控制
...
\mode<presentation>{ \section{具有报警功能的电动机单向连续运行控制} }
\begin{frame}[containsverbatim]{报警功能的电动机单向连续运行控制}
\begin{block}{控制要求}
\begin{itemize}
